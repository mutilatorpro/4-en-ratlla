 ...
 * @author inmad
 */
public class TriarJugadorEditarController implements Initializable {
    ...
    private void jugarJugador1(ActionEvent event) throws IOException {
        ...
        controlador.inicialitzarJugadors(jugador1, jugador2, jugador1);
        Scene scene = new Scene(root);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(scene);
        stage.toFront();
    ...
    private void jugarJugador2(ActionEvent event) throws IOException {
        ...
        Parent root = cargador.load();
        EditarController controlador = cargador.getController();
        controlador.inicialitzarJugadors(jugador1, jugador2, jugador2);
        Scene scene = new Scene(root);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(scene);
        stage.toFront();
